      ...
      >
        ...
        <div style={{ maxWidth: '58rem', width: '100%', position: 'relative' }}>
          ...
          <div style={{
            ...
            {[
              { icon: '💬', title: 'Chat Instantly', desc: 'Ask your AI anything — from "what should I do today?" to full task breakdowns. Your glam assistant is always on.' },
              ...
              { icon: '🌸', title: 'Motivational Vibes', desc: 'Get chic, encouraging responses that keep you inspired, energized, and absolutely slaying your goals.' },
            ].map(card => (
              <div
                key={card.title}
                style={{
